...
*/
			...
			*/
			...
			do {
				Console.Clear ();
				Console.WriteLine ("You wake up on a cold floor made of crystel from the looks of it inside a old dusty house. The crystel floor you are lying on seems to be a platform of some sort that has a faint blue glow to it. The platform of crystel seems to only be a meter or so in diamiter and then does a steep drop to a crumbeling wooden floor just a few inches bellow it. The rest of your location doesnt look too much better as with the wood floor there is a dust coverd bed in one corner and a cracked and rotting vanity mirror in the opposite one. The other side of the room consistes of an oddly sturdy solid handeless wood door with a weird star indentation in the center of the upper portion. The last notable thing in the room is a window but it seems oddly dark outside.");
				Console.WriteLine("After having a quick glanse around the room you are in you finaly get enough strength to lift yourself groggily to your feet as to figure out what to do.");
